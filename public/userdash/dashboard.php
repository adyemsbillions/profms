            ...
            <main class="main-content">
                ...
                <section id="articles" class="content-section">
                    ...
                    <div class="table-container">
                        <table class="table">
                            ...
                            <tbody>
                                <?php include 'fetch_articles_rows.php'; ?>
                            </tbody>
                        </table>
                    </div>
                </section>
                        ...
                        <form method="POST" enctype="multipart/form-data" action="submit_article.php">
                            ...
                            <div class="form-group">
                                ...
                                <select id="journal" name="journal" class="form-select" required>
                                    ...
                                    <option value="Sahel Analyst: Journal of Management Sciences">Sahel Analyst: Journal
                                        of
                                        Management Sciences</option>
                                    <option value="Journal of Resources & Economic Development (JRED)">Journal of
                                        Resources
                ...
                <section id="journals" class="content-section">
                    ...
                    <div class="journal-grid">
                        <div class="journal-card">
                            ...
                            <p class="journal-description">Leading publication in artificial intelligence applications
                                in
                        ...
                        <div class="journal-card">
                            ...
                            <p class="journal-description">Cutting-edge research in blockchain technology and
                                cryptocurrency
                                systems.</p>
                            <div class="journal-meta">
                ...
                <section id="support" class="content-section">
                    ...
                    <div class="support-grid">
                        ...
                        <div class="form-container">
                            <h3 style="color: var(--primary-color); margin-bottom: 1rem;">❓ Frequently Asked Questions
                            </h3>
                            ...
                            <div class="faq-item">
                                ...
                                <p class="faq-answer">You can edit submissions that haven't entered the review process
                                    yet.
                                </p>
                            </div>
                        </div>
